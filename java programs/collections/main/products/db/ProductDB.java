...
public class ProductDB
{
    public static Product getProduct(String productCode)
    {
        ...
        else if (productCode.equalsIgnoreCase("txtpd"))
        {
            ...
            s.setPrice(27.00);
            s.setVersion("4.7.3");
            s.setTag("superb Product");
            s.setTag("efficient to core");
        ...
        else if (productCode.equalsIgnoreCase("wrdpd"))
	{
        ...
        else if (productCode.equalsIgnoreCase("gedit"))
        {
        	Software s = new Software("gedit", "Text Editor                         ", 99.00 , "8.2.7");
        	p = s;
        }
        return p;
    }
